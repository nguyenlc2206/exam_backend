...
export class ForgotPasswordController {
    ...
    execute = catchAsync(
        async (req: Request, res: Response, next: NextFunction) => {
            ...
            const getUserByEmailResult = await this.handleGetUserByEmail(
                req.body.email
            );
            ...
            const verifyTempToken = await this.handleVerifyTempoToken(
                _tempoToken
            );
            ...
            const updatePasswordResult = await this.handleUpdatePassword(
                getUserByEmailResult.data,
                _hashPassword
            );
    ...
    /** @todo: verify token expires */
    private handleVerifyTempoToken = async (
        tempoToken: string
